    ...
    <div className="space-y-6 max-w-5xl mx-auto pb-12">
      ...
      <div className="bg-stone-900 text-stone-100 rounded-2xl p-5 sm:p-6 border border-stone-800 shadow-xl space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-stone-800 pb-4">
          ...
          {/* Quick Stats Pill */}
          <div className="flex items-center gap-3 bg-stone-800/80 p-2.5 rounded-xl border border-stone-700/60 font-mono text-xs">
            <div>
              <div className="text-[10px] text-stone-400 uppercase">Dough Temp</div>
            ...
            <div>
              <div className="text-[10px] text-stone-400 uppercase">Target Rise</div>
              <div className="text-amber-400 font-bold text-base">+{session.targetRisePercent}%</div>
            </div>
            <div className="w-px h-7 bg-stone-700" />
            <div>
              <div className="text-[10px] text-stone-400 uppercase">Target Cutoff</div>
              <div className="text-emerald-400 font-bold text-base">{session.targetVolumeMl} mL</div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-full px-3 py-1.5 border border-stone-300 rounded-lg text-sm font-mono font-bold"
                    />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      min={60}
                      max={86}
                      value={session.endingDoughTemp}
                      onChange={(e) => handleUpdateDoughTemp(parseInt(e.target.value) || 75)}
                      className="w-20 px-2 py-1 text-right font-mono font-black text-xl text-amber-800 border border-stone-300 rounded-lg bg-white"
                    />
                    <span className="text-sm font-bold text-stone-600">°F</span>
                    <span className="text-xs text-stone-500">
                      ({fahrenheitToCelsius(session.endingDoughTemp)}°C)
                    </span>
                  </div>
                </div>
              ...
              <div className="p-3 bg-stone-100 rounded-xl border border-stone-200 text-xs text-stone-700">
                ...
                <div className="flex gap-2 mt-2">
                  <button
                    ...
                    className="px-3 py-1.5 bg-stone-800 hover:bg-stone-700 text-white rounded text-xs"
                  >
                    Start 20m Lid On
                  </button>
                  <button
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-stone-200 hover:bg-stone-300 text-stone-800 rounded text-xs"
                  >
                    Start 90m Cool Down
                  </button>
                </div>
        ...
        {/* Right Column: Live Step Companion & Timers */}
        <div className="lg:col-span-4 space-y-5">
          ...
          <div className="bg-white rounded-2xl p-5 border border-stone-200 shadow-sm space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] text-stone-500 font-mono">{timerType}</span>
            </div>

            <div className="py-3 text-center bg-stone-900 rounded-xl text-white font-mono text-4xl font-extrabold tracking-widest shadow-inner">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-3 py-2 bg-stone-100 hover:bg-stone-200 text-stone-700 rounded-lg text-xs"
              >
            ...
            <div className="grid grid-cols-3 gap-1.5 pt-1">
              <button
                ...
                className="p-1.5 rounded bg-stone-50 hover:bg-stone-100 text-stone-700 text-[11px] text-center border border-stone-200 font-mono"
              >
                30m Fold
              </button>
              <button
